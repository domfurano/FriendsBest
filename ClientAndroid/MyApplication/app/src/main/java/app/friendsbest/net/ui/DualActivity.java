...
public class DualActivity extends AppCompatActivity implements
    MainView,
    ...
    private Fragment getFragmentTypeByTag(String fragmentTag){
        ...
        else if (fragmentTag.equals(PROMPT_CARD_ID))
    ...
    public void displayMessage(String message){
        // TODO: Add snack bar
        Toast.makeText(DualActivity.this, message, Toast.LENGTH_SHORT).show();
    }
